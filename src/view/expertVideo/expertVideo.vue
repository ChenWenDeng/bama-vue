    ...
    <section class="expertVideo-container">
        ...
        <section class="expertVideo-box">
            <ul>
                ...
                @load="this.init"
                > -->
                <li v-for="(item,index) in expertVideoList" :key="index" @click="jumpExpertVideoDetails(item)">
                    <div class="video-div">
...
export default {
    ...
    computed: {
        ...mapGetters('expertVideo',[
            'expertVideoList',
        ]),
        loading() {return this.$store.state.expertVideo.loading},
        finished() {return this.$store.state.expertVideo.finished},
    },
    methods:{
