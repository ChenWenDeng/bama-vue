<template>
  <section class="expertVideoDetails-container">
    <HeaderTop>
      ...
      <div class="search-container" slot="center">{{expertVideoDetailsData.post_title}}</div>
        ...
        <div v-if="commentList" class="pinjia-container" v-for="(item, index) in commentList" :key="index">
          <div v-for="(itemes, index) in item" :key="index">
            <div class="top-container">
              ...
              <img
                v-if="!itemes.user.avatar"
                src="http://img.52z.com/upload/news/image/20180419/20180419051254_75804.jpg"
                alt
              />
...
export default {
  ...
  computed: {
    ...mapGetters("expertVideoDetails", ["expertVideoDetailsData"]),
