<template>
  <div class="doctor">
    ...
    <div class="center">
      ...
      <div class="bottom">
        <van-button class="btn" @click="commit">预约挂号</van-button>
      </div>
    </div>
  </div>
</template>
    ...
    var TouchSlide = function(a) {
      ...
      k &&
        k.addEventListener("click", function() {
          (1 == w || r != p - 1) &&
            (clearTimeout(z), clearTimeout(A), r++, X());
        }),
        j &&
...
.doctor {
  ...
  .center {
    ...
    background: url("../../assets/bottom.jpg");
...
.bottom {
  ...
  .btn {
    ...
    box-shadow: 0px 3px 9px 0px rgba(249, 115, 0, 0.66);
    border-radius: 10px;
    color: #fff;
    border: none;
  }
